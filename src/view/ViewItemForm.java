...
public class ViewItemForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 850, 480));
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 620, 120, 50));
        ...
        if(view_details.getSelectedRowCount()>0){
            ...
            double taking_price=(double) dtm.getValueAt(view_details.getSelectedRow(), 4);
             ...
             double our_price= (double) dtm.getValueAt(view_details.getSelectedRow(), 6);
              int warning=(int) dtm.getValueAt(view_details.getSelectedRow(), 7);
               double qty=(double) dtm.getValueAt(view_details.getSelectedRow(), 8);
           Item item=new Item(id, batch_id, category_id, desctiption, taking_price, thoga_price, our_price, warning, qty);
